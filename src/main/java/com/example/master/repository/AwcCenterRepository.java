...
public interface AwcCenterRepository extends JpaRepository<AwcCenter, Long> {
    boolean existsByCenterId(String centerId);
    Optional<AwcCenter> findByCenterId(String centerId);
